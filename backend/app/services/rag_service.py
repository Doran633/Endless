...
class RagService:
    ...
    def ask_file(self, file_id: str, query: str, top_k: int = 3) -> AskFileResponse:
        ...
        prompt = self._build_prompt(normalized_query, retrieval.results)
    ...
    def _build_prompt(self, query: str, chunks: list[RetrievalResult]) -> str:
        context_blocks = []
